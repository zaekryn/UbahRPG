...
public class ChunkProviderOceania implements IChunkProvider
{
private Random rand;
...
public ChunkProviderOceania(World par1World, long par2, boolean par4) {
...
for (int k1 = 0; k1 < b1; ++k1)
{
         ...
         if ((d16 += d15) > 0.0D)
         {
                 ...
                 par3ArrayOfByte[j2 += short1] = (byte)Block.sandStone.blockID;//
         }
         else if (k1 * 8 + l1 < b2)
         {
...
for (int var16 = 127; var16 >= 0; var16--)
{
         ...
         {
         par3ArrayOfByte[var17] = ((byte)Block.bedrock./*UbahRPG.bedSand.*/blockID);
         }
         else
         {
