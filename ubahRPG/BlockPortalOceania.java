...
public class BlockPortalOceania extends BlockPortal
{
 public BlockPortalOceania(int id)
 {
  super(id);
  this.setUnlocalizedName("portalOceania");
 ...
 */
 ...
 for (i1 = -1; i1 <= 3; ++i1)
 {
          ...
          else if (j1 != 0 && j1 != UbahRPG.activatorFire.blockID)
          {
          return false;
          }
          }
 ...
 for (i1 = 0; i1 < 3; ++i1)
 {
          par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, UbahRPG.portalOceania.blockID, 0, 2);
 }
 }
 return true;
 }
 ...
 */
 /*public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
 {
  if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
  {
   if (par5Entity instanceof EntityPlayerMP)
   {
    ...
    if (par5Entity.dimension != UbahRPG.OceaniaID)
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, UbahRPG.OceaniaID, new OceaniaTeleporter(thePlayer.mcServer.worldServerForDimension(UbahRPG.OceaniaID)));
    }
    else
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new OceaniaTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
    }
   }
  }
 }*/
 ...
 if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
          ...
          else if (thePlayer.dimension != UbahRPG.OceaniaID)
          {
                  thePlayer.timeUntilPortal = 10;
                  thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, UbahRPG.OceaniaID, new OceaniaTeleporter(thePlayer.mcServer.worldServerForDimension(UbahRPG.OceaniaID)));
          }
