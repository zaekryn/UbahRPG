...
public class BlockActivatorFire extends BlockFire
{
private int[] chanceToEncourageFire = new int[256];
private int[] abilityToCatchFire = new int[256];
@SideOnly(Side.CLIENT)
private Icon[] iconArray;
public BlockActivatorFire(int par1)
{
super(par1);
setTickRandomly(true);
this.setUnlocalizedName("activatorFire");
}
...
if ((par1World.getBlockId(par2, par3 - 1, par4) != Block.sandStone.blockID) || (!UbahRPG.portalOceania.tryToCreatePortal(par1World, par2, par3, par4)))
{
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
{
par1World.setBlockToAir(par2, par3, par4);
...
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!this.canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
{
...
{
this.iconArray = new Icon[] { par1IconRegister.registerIcon(UbahRPG.modid + ":" + (this.getUnlocalizedName().substring(5)) + "_0"), par1IconRegister.registerIcon(UbahRPG.modid + ":" + (this.getUnlocalizedName().substring(5)) + "_1") };
}
@SideOnly(Side.CLIENT)
